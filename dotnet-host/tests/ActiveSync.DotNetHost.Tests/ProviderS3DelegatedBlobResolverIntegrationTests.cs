            ...
            config =>
            {
                config.AddInMemoryCollection(
                    new Dictionary<string, string?>
                    {
                        ...
                        ["ActiveSync:Storage:S3Delegated:CircuitBreakerFailureThreshold"] = "10",
                        ["ActiveSync:Storage:S3Delegated:CircuitBreakerOpenSeconds"] = "60"
                    }
                );
            }
        );
            ...
            config =>
            {
                config.AddInMemoryCollection(
                    new Dictionary<string, string?>
                    {
                        ["ActiveSync:Providers:BlobStorage"] = "S3Delegated",
                        ["ActiveSync:Storage:S3Delegated:BaseUrl"] = "https://delegate.test",
                        ["ActiveSync:Storage:S3Delegated:MaxRetries"] = "0",
                        ["ActiveSync:Storage:S3Delegated:CircuitBreakerFailureThreshold"] = "1",
                        ["ActiveSync:Storage:S3Delegated:CircuitBreakerOpenSeconds"] = "60"
                    }
                );
            }
