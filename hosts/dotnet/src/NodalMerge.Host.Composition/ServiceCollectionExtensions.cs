...
public static class ServiceCollectionExtensions
{
    ...
    {
        var options = NodalMergeHostProviderOptions.FromConfiguration(configuration);
        Validate(options);
    ...
    )
    {
        ...
        if (string.Equals(options.AuthProvider, "JwtBridgeSidecar", StringComparison.Ordinal))
        {
            ...
            services.AddHttpClient("NodalMerge.JwtBridgeSidecar", (sp, httpClient) =>
            {
    ...
    private static void Validate(NodalMergeHostProviderOptions options)
    {
...
{
    private const string SidecarHttpClientName = "NodalMerge.JwtBridgeSidecar";
