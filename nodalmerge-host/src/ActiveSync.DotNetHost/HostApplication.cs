            ...
            return Results.Ok(new
            {
                ...
                mongo = new
                {
                    database = GetConfigValue(
                        cfg,
                        "NodalMerge:Storage:Mongo:DatabaseName",
                        "ActiveSync:Storage:Mongo:DatabaseName")
                },
                delegated = new
                {
                    ...
                    putPath = GetConfigValue(
                        cfg,
                        "NodalMerge:Storage:S3Delegated:PutPath",
                        "ActiveSync:Storage:S3Delegated:PutPath"),
                    getPath = GetConfigValue(
                        cfg,
                        "NodalMerge:Storage:S3Delegated:GetPath",
                        "ActiveSync:Storage:S3Delegated:GetPath")
                }
            });
        });
